########### sumo env 6th
## main differences on the compute_observations() method and encode() methods
...
class SumoEnvironments(gym.Env):
    ...
    def compute_observations(self):
        ...
        if '1' in obs.keys():
            ...
            obs['1'].append(phase['gneJ0'])
        if 'gneJ5' in obs.keys():
            obs['gneJ5'].append(phase['1'])
            obs['gneJ5'].append(phase['gneJ10']) 
        if 'gneJ10' in obs.keys():
            obs['gneJ10'].append(phase['gneJ5'])
            obs['gneJ10'].append(phase['gneJ10'])  
            obs['gneJ10'].append(phase['gneJ13'])
        if 'gneJ0' in obs.keys():
            obs['gneJ0'].append(phase['1'])
            obs['gneJ0'].append(phase['gneJ10'])
            obs['gneJ0'].append(phase['gneJ15'])
        if 'gneJ13' in obs.keys():
            obs['gneJ13'].append(phase['gneJ15'])
            obs['gneJ13'].append(phase['gneJ10'])
        if 'gneJ15' in obs.keys():
            obs['gneJ15'].append(phase['gneJ13'])
            obs['gneJ15'].append(phase['gneJ0']) 
    ...
    def encode(self, state):
        ...
        return tuple(density_queue + phase)
